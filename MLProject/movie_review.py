...
def _create_pos_neg_features():
    ...
    with open('/media/New Volume/Acads/UIClinks/Machine Learning/Project/Movie_Review_Sentiment_Analysis/Movie_Review_Sentiment_Analysis/opinion-lexicon-English/positive-words.txt', 'r') as f:
    ...
    with open('/media/New Volume/Acads/UIClinks/Machine Learning/Project/Movie_Review_Sentiment_Analysis/Movie_Review_Sentiment_Analysis/opinion-lexicon-English/negative-words.txt', 'r') as f:
